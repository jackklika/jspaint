...
// attributes in whatever order; a section may hold nested <div>s, so the end tag is matched by depth, not by the
// first </div>). Used by <x-toc> and the folder view's summaries.
