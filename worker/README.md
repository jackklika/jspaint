...
| `jspaint-editor` (`editor/`) | `https://jspaint-editor.jklika2.workers.dev/` | The Paint app (static assets built into `editor/dist`) and the API Paint uses to publish: site file CRUD behind a shared secret, plus the GifCities proxy. |
