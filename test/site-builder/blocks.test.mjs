...
assert.deepEqual(tool_titles.slice(16, 24), ["---", "Pointer", "Select Elements", "Text Box", "Web Text", "Section", "Divider", "Link"]);
...
assert.ok(tool_titles.includes("GIF Picker") && tool_titles.includes("Guestbook") && tool_titles.includes("Last Updated") && tool_titles.includes("Page Style"), tool_titles.join(","));
