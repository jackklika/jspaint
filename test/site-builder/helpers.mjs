 ...
 * @param {{ init?: (arg?: any) => void, init_arg?: any, viewport?: { width: number, height: number } }} [options] - `init` runs before the page's scripts (e.g. to seed localStorage), with `init_arg`
 */
export async function open_paint({ init, init_arg, viewport = { width: 1280, height: 800 } } = {}) {
