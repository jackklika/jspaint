...
- **The globe** — a 50×50 button at the bottom of the toolbox (a web-1.0 spinning pixel earth): My Site in one click. Signed out it opens Sign In; signed in it shows the site view (address, this page, Browse Files… — the My Site window's Files tab, Save, Share, Sign Out); a guest sees whose page they're on and Share (2026-09-10, `src/site-button.js`).
